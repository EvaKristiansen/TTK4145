...
fsm_storage_loop(States,Last_known_floors,Directions) ->
	receive
		...
		{set_state, {Key,State}} -> 
			...
			fsm_storage_loop(Updated_states,Last_known_floors,Directions);
		...
		{set_last_known_floor, {Key,Last_known_floor}} -> 
			...
			fsm_storage_loop(States,Updated_last_known_floors,Directions);

		{set_state, {Key,Direction} -> 
			Updated_directions = dict:append(Key, Direction, dict:erase(Key, Directions)),
			fsm_storage_loop(States,Last_known_floors,Updated_directions);
